 ...
 * `InstanceAgentsInternal` that are not accessible from the instance's state.
 *
 ...
 *
 * @param agents The `InstanceAgentsInternal` to be scrubbed.
 */
export const scrubAgents = (agents: InstanceAgentsInternal): void => {
